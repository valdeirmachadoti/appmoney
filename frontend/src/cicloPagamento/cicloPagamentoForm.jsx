        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <Summary creditos={somaCreditos} debitos={somaDebitos} />

                    <Field name='nome' component={LabelAndInput} readOnly={readOnly}
                        label="Nome" cols="12 4" placeholder="Informe o nome" icon="list" />

                    <Field name='mes' component={LabelAndInput} type="number" readOnly={readOnly}
                        label="Mês" cols="12 4" placeholder="Informe o mês" icon="calendar"
                    />
                    <Field name='ano' component={LabelAndInput} type="number" readOnly={readOnly}
                        label="Ano" cols="12 4" placeholder="Informe o ano" icon="calendar"
                    />
